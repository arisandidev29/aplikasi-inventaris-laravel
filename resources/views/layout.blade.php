                ...
                <div class="flex flex-col h-full">
                    ...
                    <div class="flex items-center justify-between h-20 px-6 bg-blue-600/5 border-b border-slate-800">
                        <div class="flex items-center gap-3">
                            ...
                            <span
                                class="text-xl font-black tracking-tighter text-white uppercase italic">StockHub</span>
                        </div>
                    ...
                    <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto sidebar-scroll">
                        <p class="px-3 mb-2 text-[10px] font-black tracking-[0.2em] text-slate-600 uppercase italic">
                            Main
                            Navigation</p>
                        ...
                        <div class="flex items-center gap-3">
                            <div class="hidden sm:block text-right">
                                <p class="text-xs font-black text-white italic uppercase tracking-tighter">
                                    {{ Auth::user()->name }}</p>
                                <p class="text-[9px] text-slate-500 font-bold uppercase tracking-widest">Administrator
                                </p>
                            </div>
                            <div
