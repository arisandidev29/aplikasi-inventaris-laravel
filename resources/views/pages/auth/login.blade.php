    ...
    <div class="flex min-h-screen items-center justify-center p-4 lg:p-8">
        <div class="w-full max-w-md">
            ...
            <div class="mb-10 text-center">
                <div
                    class="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-blue-600 shadow-xl shadow-blue-900/40">
            ...
            <div class="overflow-hidden rounded-3xl border border-slate-800 bg-[#111827] shadow-2xl">
                <div class="p-8 lg:p-10">
                    ...
                    @if ($errors->any())
                        <div
                            class="mb-6 flex items-start gap-3 rounded-xl border border-red-500/50 bg-red-500/10 p-4 text-sm text-red-400">
                    ...
                    <form action="{{ route('login') }}" method="POST" class="space-y-6" x-data="{ loading: false }"
                        @submit="loading = true">
                        @csrf

                        <!-- Input Email -->
                        <div>
                            <label for="email" class="mb-2 block text-sm font-medium text-slate-300">Alamat
                                Email</label>
                            <div class="relative">
                        ...
                        <div x-data="{ show: false }">
                            <div class="flex items-center justify-between mb-2">
                                <label for="password" class="block text-sm font-medium text-slate-300">Kata
                                    Sandi</label>
                            ...
                            <div class="relative">
                                ...
                                <button type="button" @click="show = !show"
                                    ...
                                    <svg x-show="show" x-cloak xmlns="http://www.w3.org/2000/svg" class="h-5 w-5"
                                        viewBox="0 0 20 20" fill="currentColor">
                                        <path fill-rule="evenodd"
                                            d="M3.707 2.293a1 1 0 00-1.414 1.414l14 14a1 1 0 001.414-1.414l-1.473-1.473A10.014 10.014 0 0019.542 10C18.268 5.943 14.477 3 10 3a9.991 9.991 0 00-4.512 1.074l-1.78-1.781zm4.261 4.26l1.514 1.515a2.003 2.003 0 012.45 2.45l1.514 1.514a4 4 0 00-5.478-5.478z"
                                            clip-rule="evenodd" />
                                        <path
                        ...
                        <div class="flex items-center">
                            ...
                            <label for="remember_me" class="ml-2 block text-sm text-slate-400">Ingat saya di perangkat
                                ini</label>
                        </div>
